...
def main():
    ...
    if args.height:
        ...
        model_D_path = osp.join(here,'results', DATASET + '_height_unet', 'checkpoints', 'model_D_iter' + str(args.resume) +'.pth')
    else:
        model_path = osp.join(here,'results', DATASET + '_no_height_unet', 'checkpoints', 'model_iter' + str(args.resume) +'.pth')
        model_D_path = osp.join(here,'results', DATASET + '_no_height_unet', 'checkpoints', 'model_D_iter' + str(args.resume) +'.pth')
    i_iter=0
    if args.resume>0:
