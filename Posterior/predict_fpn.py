        ...
        for source in SOURCE:
            for target in TARGET:
                for dataset in DATASET:
                    ...
                    out_dir = './records'
                    if height:
                        filename = dataset + '_' + source + '_' + target + '_height_fpn.log'
                    else:
                        filename = dataset + '_' + source + '_' + target + '_no_height_fpn.log'
